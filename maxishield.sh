...
PASS=$2
##Authentication
data=$(curl -sb -X POST  -F "connect=true" -F "user=$USERNAME" -F "pass=$PASS" "https://panel.maxishield.io/connect.php")
...
wget https://gitfront.io/r/user-1492265/58156598dbd7bdc13e6665937fe1f67b8c23b788/auth.sh/raw/default
